...
class Gripper2(Sofa.Core.Controller, PivotizedArticulatedInstrument):
    def __init__(
        self,
        ...
        self.collision_node_shaft = self.physical_shaft_node.addChild("approximated_collision_shaft_jaw_2")
        ...
        self.contact_listener = {
            "shaft": self.gripper_node.addObject(
                "ContactListener",
                name="contact_listener_intestine_shaft",
                collisionModel1=self.intestine.collision_model_node.TriangleCollisionModel.getLinkPath(),
                collisionModel2=self.sphere_collisions_shaft.getLinkPath(),
            ),
            "jaw": self.gripper_node.addObject(
                "ContactListener",
                name="contact_listener_intestine_jaw",
                collisionModel1=self.intestine.collision_model_node.TriangleCollisionModel.getLinkPath(),
        ...
        self.grasping_force_field = {
            "shaft": self.intestine.collision_model_node.addObject(
            ...
            "jaw": self.intestine.collision_model_node.addObject(
                "RestShapeSpringsForceField",
    ...
    def identify_execessive_force(self):
        if self.max_grasp_force is not None:
            for jaw in self.contact_listener:
                ...
                intestine_forces = self.intestine.collision_model_node.MechanicalObject.force.array()[indices[active_grasps]]
    ...
    def _attempt_grasp(self):
        ...
        for jaw, contact_listener in self.contact_listener.items():
            ...
            for id, contact in enumerate(contacts):
                ...
                triangle_point_index = self.intestine.collision_model_node.loader.triangles.array()[triangle_index_on_intestine][0]

                intestine_position = self.intestine.collision_model_node.MechanicalObject.position.array()[triangle_point_index]
