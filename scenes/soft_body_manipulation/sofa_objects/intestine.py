...
from sofa_env.sofa_templates.materials import MATERIALS_PLUGIN_LIST, Material,ConstitutiveModel
...
class Intestine(DeformableObject):
    def __init__(
        self,
        ...
        board_texture_path = '/home/saketh/SOFA/v23.06.00/bin/lapgym/sofa_env/sofa_env/scenes/soft_body_manipulation/meshes/tissue_surface_texture.png'

        visual_model_func = partial(add_visual_model, texture_file_path='/home/saketh/SOFA/v23.06.00/bin/lapgym/sofa_env/sofa_env/scenes/soft_body_manipulation/meshes/tissue_surface_texture.png')
        #partial(add_visual_model, color=(1, 1, 0))##
        ...
        print(self.mechanical_object.position.getLinkPath())
